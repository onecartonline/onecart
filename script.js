document.addEventListener("DOMContentLoaded", function () {
    ...
    function searchProduct() {
        ...
        results.innerHTML = `
            ...
            <div class="card"><img src="image/aliexpress.png" alt="AliExpress"><h4>AliExpress</h4><p>Global online marketplace with deals</p><const aliExpressLink = `https://s.click.aliexpress.com/e/_c3PgCRa7?SearchText=${encodeURIComponent(query)}`;
